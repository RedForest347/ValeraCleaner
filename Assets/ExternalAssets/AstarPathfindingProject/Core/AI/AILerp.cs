...
namespace Pathfinding
{
    ...
    public class AILerp : VersionedMonoBehaviour, IAstarAI
    {
        ...
        //ABPath pathCustom;
        public virtual void SearchNewPathCustom(Vector2 target)
        {
            onSearchPath?.Invoke();
            ...
            previousPosition2 = tr.position;
            previousPosition1 = simulatedPosition = tr.position;
        ...
        protected virtual void Update()
        {
            ...
            {
                //Debug.Log("before SearchPath " + path?.path.Count);
                SearchPath();
                //Debug.Log("after SearchPath " + path?.path.Count);
            ...
            //Debug.Log("after after SearchPath " + path?.path.Count);
            //Debug.Log("after after seeker.GetCurrentPath()?.path.Count " + seeker.GetCurrentPath()?.);
            //Debug.Log("after after seeker.GetCurrentPath()?.path.Count " + seeker.GetCurrentPath()?.vectorPath.Count);
            //Debug.Log("after after seeker.GetCurrentPath()?.path.Count " + seeker.GetCurrentPath()?.next?.path.Count);
        }
